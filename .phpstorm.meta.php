...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\Sula\Desktop\Apps Technology\Test\notes-manager\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\Sula\\Desktop\\Apps Technology\\Test\\notes-manager\\public\\storage',
...
'profile.update','profile.destroy','user.dashboard','user.notes.index','user.notes.create',
'user.notes.store','user.notes.edit','user.notes.update','user.notes.destroy','admin.dashboard',
'admin.users.index','register','login',
...
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
